...
abstract base class EfficientAccessIterable<E> extends Iterable<E> {
  /// Returns a [StateError] with the message 'No elements'.
  static Error _noElements() => StateError('No elements');

  /// Returns a [StateError] with the message 'More than one element'.
  static Error _moreThanOneElement() => StateError('More than one element');

  /// Creates a new efficient access iterable.
  const EfficientAccessIterable();
  ...
  @override
  Iterator<E> get iterator => _EfficientAccessIterator(this);
...
final class _SubRangeIterable<E> extends EfficientAccessIterable<E> {
  _SubRangeIterable(
    this._iterable, //
    this._start, [
    int? count,
  ...
  final EfficientAccessIterable<E> _iterable;
  final int _start;
...
final class _EfficientAccessIterator<E> implements Iterator<E> {
  _EfficientAccessIterator(this._iterable);
