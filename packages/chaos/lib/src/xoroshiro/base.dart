...
abstract final class Xoshiro128 implements PersistentRandom {
  /// Returns a random seed generated by [Xoshiro128P], seeded with and XORd by
  /// [DateTime.now].
  ///
  /// The result is a reasonably good random seed.
  static int randomSeed() {
    final time = DateTime.now().microsecondsSinceEpoch;
    final rng = Xoshiro128P(time);
    return rng.nextInt() ^ time;
  }

  /// Creates a new [Xoshiro128] instance.
  ///
  /// If [seed] is not provided, a random seed is generated using [randomSeed].
  ///
  /// The default implementation is [Xoshiro128P].
  factory Xoshiro128([int seed]) = Xoshiro128P;
