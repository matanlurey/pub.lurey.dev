...
void runSuite(
  ...
  required Grid<(int, int)> Function(
    int width,
    int height,
    (int, int) Function(int x, int y),
  ) generate,
  required Grid<int> Function(
    List<int> cells, {
    required int width,
