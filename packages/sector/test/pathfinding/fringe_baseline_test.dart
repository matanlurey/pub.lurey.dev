...
void main() {
  final adapted = fringeAstar.asBestPathfinder(
  ...
  test('should find a direct path', () {
    ...
    final path = adapted.findBestPath<int>(
      graph.asWeightedForced(),
      1,
      Goal.node(3),
      tracer: TestTracer<int>(expectRepeatedVisits: true),
    );
  ...
  test('should find a path in a tree-like structure, not get stuck', () {
